...
import chap98_homework.employee.ContractEmployee;
import chap98_homework.employee.Employee;
import chap98_homework.employee.RegularEmployee;
import chap98_homework.employee.TempEmployee;
		...
		while(true) {
			...
			switch(input) {
				...
				case 3 : 
					...
					workDay = sc.nextInt();
					ep[eno] = new ContractEmployee(eno, name, pay, 3, hireYear);
					ep[eno].showEmployeeInfo();
					System.out.println("----------------");
					break;
				case 4 : 
