...
public class _0314_advanceIf {
	...
	public static void main(String[] args) {
		...
		for(int a = 0; a < str.length(); a++) {
			...
			if(ch2 >= 97 && ch2 <= 122) { //소문자 => 대문자
				forthCh2 = (char)((int)ch2 - 33);
			} else if(ch2 + 33 > 122) { //+ 33 하면 결과값 97 + 122 = Û 나옴
				forthCh2 = (char)(('a' - 123) + (int)(ch2 + 33));
			} else if(ch2 >= 65 && ch2 <= 90) { //대문자 => 소문자
				forthCh2 = (char)((int)ch2 + 33);
			}
