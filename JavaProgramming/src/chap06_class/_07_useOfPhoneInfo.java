...
public class _07_useOfPhoneInfo {
	...
	public static void main(String[] args) {
		...
		//switch~case문에서 break; 시 switch~case문만 종료하기 때문에 while문을 종료시킬 플래그
		...
		while(true) {
			...
			//nextInt는 줄바꿈 값을 처리하지 못하기 때문에 숫자 입력 후 엔터를 누르면 엔터값이 남아 있다
				...
				case 3:
					while(true) {
						...
						if(index < 1 || index > 100) {
							System.out.println("1~100 안의 값을 입력해 주세요.");
							continue;
						} else {
